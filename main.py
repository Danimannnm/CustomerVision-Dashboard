        ...
        if uploaded_file is not None:
            try:
                ...
                if st.session_state.get('show_original', True):
                    ...
                    display_image = self.image_processor.resize_image(image, max_width=600, max_height=450)
                    st.image(display_image, caption="Upload successful", use_container_width=True)
    ...
    def _render_detection_section(self):
        ...
        with col2:
            detect_button = st.button(
                ...
                help="Click to start object detection analysis"
            )
